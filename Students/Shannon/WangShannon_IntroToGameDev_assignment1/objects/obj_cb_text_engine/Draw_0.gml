...
draw_sprite_stretched(spr_box_7, 0, panel_x - _clamped_width / 2, panel_y - _clamped_height / 2 - 73, _clamped_width, _clamped_height);

if (text_line_ready && !text_is_choice){
	var _xmod = abs(sin(2*get_timer()/300000))*5
	draw_arrow(
	panel_x+(final_width/2)-36-_xmod,
	panel_y+(final_height/2)-32 - 73,
