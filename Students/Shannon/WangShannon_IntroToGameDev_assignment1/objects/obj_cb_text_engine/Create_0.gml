...
text_obj = instance_create_layer(x,y,"UI",obj_cb_dialogue);

char_obj = instance_create_layer(x,y,"Instances",obj_cb_character);
global.char = char_obj;
...
function add_text_elem(_x, _y, _char, _state, _txt, _fx = [], _xmax = 442){
